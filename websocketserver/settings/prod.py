...
ALLOWED_HOSTS = [os.environ.get('POD_IP'), '127.0.0.1', 'localhost', 'chat-server-bt4zme4z7q-uc.a.run.app', 'chat-server-dev-bt4zme4z7q-uc.a.run.app']
...
CHAT_REDIS_KEY = "CHATHISTORYPROD"
CHAT_GROUP = "HL_PROD"
MINIGAME_GROUP = "HL2_PROD"
